                ...
                <div class="row">
                    <div class="col-md-12">
                        <form tabindex="1" action="{{ route('parcel.create_parcel_process') }}" method="post"
                            ...
                            @csrf
                            <input type="hidden" value="collection" name="status_process">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5 class="text-center">تحصيل طرد</h5>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-info">تحصيل الطرد</button>
                                    </div>
                                </div>
                            </div>
                        </form>
